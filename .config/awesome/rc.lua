...
-- }}}
tags = {
    names  = { "term", "gvim", "Chrome", 4, 5, 6, 7, 8, 9 },
...
--cpuwidget_graph:set_background_color("#494B4F")
--cpuwidget_graph:set_color("#FF5656")
--cpuwidget_graph:set_gradient_colors({ "#FF5656", "#88A175", "#AECF96" })
---- Register widget
--vicious.register(cpuwidget_graph, vicious.widgets.cpu, "$1")
